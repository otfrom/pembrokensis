...
** ace-window in addition to winum
...
I really like the ef-themes from Prot. Let's use them.

#+begin_src emacs-lisp :noweb-ref color-theme
  (use-package ef-themes
    :init (setq ef-themes-to-toggle '(ef-bio ef-rosa))
    :config (ef-themes-select 'ef-bio))
#+end_src
...
#+begin_src emacs-lisp :noweb-ref pembrokensis-completion-ui
  ...
  ;; config inspared by
  ;; https://protesilaos.com/emacs/dotemacs#h:22e97b4c-d88d-4deb-9ab3-f80631f9ff1d
  ;; as using :init wasn't working
...
To make consult-recent work we need to have recentf mode running
...
#+begin_src emacs-lisp :noweb-ref pembrokensis-completion-ui
  ...
  (use-package consult
    ...
    (require 'consult-xref) ; FIXME: This shouldn't be needed really
...
#+begin_src emacs-lisp :noweb-ref pembrokensis-completion-ui
  ;; Taken from https://protesilaos.com/emacs/dotemacs#h:804b858f-7913-47ef-aaf4-8eef5b59ecb4
  (use-package corfu
    :ensure t
...
#+begin_src emacs-lisp :noweb-ref pembrokensis-clojure
  ;;; TODO Put my own clojure config here
  ;; (use-package corgi-clojure
...
#+begin_src emacs-lisp :noweb-ref pembrokensis-emacs-lisp
  ;;; TODO pub my own emacs-lisp config here
  ;; (use-package corgi-emacs-lisp
...
#+begin_src emacs-lisp :noweb-ref pembrokensis-stateline
  (use-package corgi-stateline
    :load-path "site-lisp/"
    :config (global-corgi-stateline-mode))
#+end_src
...
#+begin_src emacs-lisp :noweb-ref pembrokensis-corgi-bindings
  (use-package corgi-bindings
    :load-path "site-lisp/corgi-bindings/")
#+end_src
...
#+begin_src emacs-lisp :noweb-ref keycast
  (use-package keycast
    :config (keycast-tab-bar-mode))
#+end_src
